...
class ai_model:
    ...
    def train(self, train_dataloader, valid_dataloader):
        ...
        for epoch in range(self.config[str_num_epochs]):
            ...
            #     print()
            #     print('Epoch {}/{}'.format(epoch + 1, self.config[str_num_epochs]))
    ...
    def predict(self, data:str or pd.DataFrame or list, data_type:str, batch_size=50)-> list:
        '''
        data_type = { 'csv' | 'pkl' | 'df' | 'list'}
        '''
        try:
